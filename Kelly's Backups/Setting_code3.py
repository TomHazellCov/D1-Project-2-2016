...
#So I use the class set up by Tom
from SaveSettings import *
#Pickle is for saving the settings near the end
import pickle 
...
#tells the button to run the makefile function 
    ...
    def makefile(self):
        ...
        A= (self.combo1.currentText())
        B= (self.combo2.currentText())
        C= (self.combo3.currentText())
        D= (self.combo4.currentText())
        FILE= prefsStore(A, B, C, D)
